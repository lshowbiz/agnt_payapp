 ...
 * 
 */
public class Bill99UtilMobileImpl implements IPayUtil {
	final String pubKeyName = "key/app/99bill.cert.rsa.20340630.cer";
	public static PublicKey publicKey = null;
	@Override
	public String[] getConfiguration() {
		// TODO Auto-generated method stub
		return new String[] { "1,手机端快钱", "29,30", "<result>1</result><redirecturl>http://e.jmtop.com/gate</redirecturl>" };
	}
	...
	private JfiPayLog setJfiPayLog(HttpServletRequest request, String companyCode) {
		...
		if (bean != null) {
			...
			entity.setDataType("2");// 数据来源，2：PC
		}
		return entity;
	}
	...
	private JfiPayLog checkJfiPayLog(JfiPayLog entity, String bindCard, String bindMobile) {
		...
		int rtnMsg = 0;
		boolean flag = pki.enCodeByCerMobile(merchantSignMsgVal, entity.getSign(), pubKeyName);
		if (flag) {
